...
export default function Serviceboxes() {
  return (
    <>
      <section className="relative overflow-hidden bg-[#07111E] px-4 sm:px-6 sm:py-20 lg:pt-20 lg:pb-0">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {servicesbox.map(({ title, description, Scene }, i) => (
              <FadeIn key={title} delay={(i % 3) * 0.1}>
                <div className="group flex flex-col overflow-hidden rounded-2xl border border-white/[0.06] bg-[#091424] p-3 shadow-[0_10px_40px_-20px_rgba(0,0,0,0.6)] transition-all duration-300 hover:-translate-y-1 hover:border-emerald-400/40 hover:shadow-[0_10px_40px_-15px_rgba(16,185,129,0.35)]">
        ...
        {/* ---services--- */}
        <div className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Heading */}
              ...
              {steps.map((step, i) => {
                ...
                return (
                  <FadeIn key={step.number} delay={(i % 3) * 0.1}>
                    <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.06] bg-[#091424] p-6 shadow-[0_10px_40px_-20px_rgba(0,0,0,0.6)] transition-all duration-300 hover:border-emerald-400/40 hover:shadow-[0_10px_40px_-15px_rgba(16,185,129,0.35)] sm:p-7">
